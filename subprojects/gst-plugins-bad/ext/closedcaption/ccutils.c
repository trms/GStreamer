...
G_DECLARE_FINAL_TYPE (CCBuffer, cc_buffer, GST, CC_BUFFER, GstObject);
G_DEFINE_TYPE (CCBuffer, cc_buffer, GST_TYPE_OBJECT);
    ...
    guint * field2_padding, guint * cc_data_len)
{
  ...
  *field2_padding = 0;
  ...
  if (!buf->output_padding && write_cea608_1_size == 0 && write_cea608_2_size == 0) {
    *field1_padding = 0;
    *field2_padding = 0;
  }
